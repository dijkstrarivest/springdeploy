package com.example.springdeploy.repository; // Declaração do pacote onde esta interface de repositório está localizada.
...
import com.example.springdeploy.model.Class; // Importa a classe de modelo Class para especificar a entidade relacionada.
